...
const ReturnStrArr=　[
  ...
  ['よーく聞いてくださいね。今から３回私が火の魔法を打ちます。どれが一番遠くに飛んでいったか、当ててみてください！まず１回目！'+'<audio src="soundbank://soundlibrary/explosions/fireballs/fireballs_10"/>'+'<audio src="soundbank://soundlibrary/guns/cannons/cannons_05"/>'+'次の２回目！'+'<audio src="soundbank://soundlibrary/explosions/fireballs/fireballs_10"/>'+'<audio src="soundbank://soundlibrary/guns/cannons/cannons_09"/>'+'最後の3回目！'+'<audio src="soundbank://soundlibrary/explosions/fireballs/fireballs_10"/>'
  ,'爆発する瞬間の音を聞いてみて','一番遠くで爆発してるのは？','三回目','最後','三番目'],
];
