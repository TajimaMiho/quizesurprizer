...
const ReturnStrArr=　[
  ...
  ["車椅子って10回言って" + '。' + '。' + '。' + 'メリー？', "ひっくり返るんだよ？", "文字を逆さにしてみたら？","クリスマス", "くりすます", "クリスます"],
];
...
"おはようございます！勇者様！今日は勇者様に朗報があるんですよ...なんと！私アレクサ、魔法を使えるようになったのです！！え？どんな魔法なのかって？火です、火。音だけじゃ微妙ですか？でもでも安心してください！もうすでに練習もしましたから！(火の音)明日からのクイズにはこんなのも使っちゃいますよー！", "し", "ご", "ろく", "なな", "はち", "きゅう", "じゅう"];
var num;
var count = 0;
var hint = 0;
...
const LaunchRequestHandler = {
    ...
    async handle(handlerInput) {
        ...
        if(count === 0) {
            speakOutput = '<audio src="soundbank://soundlibrary/scifi/amzn_sfx_scifi_laser_gun_fires_06"/>' + 'この世界にいつか到来すると言われている、ネムール伯爵、彼は、人が、早起きせずに怠惰にしている時に、ひどく活性化すると言われているのです。彼の野望を止めるために、勇者様には、毎日早起きして欲しいのです。' + makeStateSpeach();
            count++;
        }
