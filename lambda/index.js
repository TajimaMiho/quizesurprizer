...
const LaunchRequestHandler = {
    ...
    async handle(handlerInput) {
        ...
        if(count === 0) {
            speakOutput = 'この世界にいつか到来すると言われている、ネムール伯爵。彼は、人が早起きせずに怠惰にしている時に、ひどく活性化すると言われているのです。彼の野望を止めるために、勇者様には、毎日早起きして欲しいのです。そういえば大事なことを言い忘れていました。この世界での合言葉は、開けごまです。絶対に忘れないでくださいね。' + makeStateSpeach();
            count = 1;
        }
