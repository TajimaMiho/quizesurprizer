...
const ReturnStrArr=　[
  ...
  ['よーく聞いてくださいね。今から３回私が火の魔法を打ちます。どれが一番遠くに飛んでいったか、当ててみてください！まず１回目！'+'<audio src="soundbank://soundlibrary/explosions/fireballs/fireballs_10"/>'+'<audio src="soundbank://soundlibrary/guns/cannons/cannons_05"/>'
  +'次の２回目！'+'<audio src="soundbank://soundlibrary/explosions/fireballs/fireballs_10"/>'+'<audio src="soundbank://soundlibrary/guns/cannons/cannons_09"/>'
  +'最後の3回目！'+'<audio src="soundbank://soundlibrary/explosions/fireballs/fireballs_10"/>'+'<audio src="soundbank://soundlibrary/guns/cannons/cannons_01"/>','爆発する瞬間の音を聞いてみて','一番遠くで爆発してるのは？','三回目','最後','三番目'],
];
const Serifu = ["おはようございます。今日もいい日ですね。ところで、あなたが今日早起きしてくれたことで危機が一つ去りました。ネムール伯爵の使者が一人去ったのです。え？そんなシステムだったのかって？そうですよ、あなたが早起きすればするほどネムール伯爵が弱っていくのです...おっと、失礼しました。私はあなたの味方ですのでご安心ください」またもやわけのわからないことを言い出すアレクサ。どうやらこいつは俺に話しかけているらしいのだが、なんなんだ一体。",
"に", "さん", "し", "ご", "ろく", "なな", "はち", "きゅう", "じゅう"];
var num;
var count = 0;
var hint = 0;
